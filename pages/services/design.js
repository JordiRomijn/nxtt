    ...
    <Layout title="Design detail">
      <div className="container">
        <div className="detail">
          ...
          <h3>
            Zo zorgen wij ervoor dat jouw bezoekers een goede ervaring hebben
          ...
          <div className="proces__inner">
            <div className="proces__inner-main">
              ...
              <div className="main__text">
                ...
                <p>
                  Als eerst maken wij Wireframes, waarmee wij inplannen wat er
              ...
              <div className="main__text">
                <span>Design</span>
                <p>
                  Vervolgens gaan we het desgin maken, waarbij wij alles afmaken
                </p>
              </div>
              <div className="main__text">
                <span>Aanpassen</span>
                <p>
                  ...
                  feedback passen wij het desgin aan. Dit herhaalt zich een
                  aantal keer tot het design helemaal naar wens is.
                </p>
              </div>
            </div>
          </div>
